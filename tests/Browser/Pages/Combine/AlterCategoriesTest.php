    ...
    public function testAlterCategories()
    {
        $this->browse(function (Browser $browser) {
            $browser->visit(AdminLoginPage::Admin_Login['login_url'])
                ...
                ->type(CreCategoriesPage::Cate_Page['ch_title'], CreCategories::Alter_Cate_Data['ch_title'])
                ->type(CreCategoriesPage::Cate_Page['en_title'], CreCategories::Alter_Cate_Data['en_title'])
                ->type(CreCategoriesPage::Cate_Page['ch_keywords'], CreCategories::Alter_Cate_Data['ch_keywords'])
